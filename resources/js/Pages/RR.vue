<template>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card p-3 d-flex">
                <label>Quantum</label>
                <input :disabled="contador > 0" placeholder="0" class="form-control mb-2" type="number" v-model="quantum">
            </div>
        </div>
        <h4>Procesos</h4>
    ...
    <template v-if="contador > 0">
        ...
        <div class="card p-3 d-flex">
            <div class="card-title p-2">
                <h1 class="card-title">Diagrama RR</h1>
            </div>
            <div id="chart">
    ...
    <template v-if="finalizado">
        ...
        <div class="row">
            <div class="col-6">
                <a :href="route('rr')" class="btn btn-warning mb-5 w-100">Reiniciar datos</a>
            </div>
            <div class="col-6">
...
export default {
    ...
    setup(props){
        ...
        const ejecutar = () => {
            ...
            correrAlgoritmo()
            contador.value++
            contadorQuantum.value++

            if(contadorQuantum.value > quantum.value) contadorQuantum.value = 1;
        ...
        const correrAlgoritmo = () =>{
            ...
            if(listos.value.length > 0){
                if(ejecucion.value == null){
                    ...
                    contadorQuantum.value = 0;
                }else if(ejecucion.value != null && contadorQuantum.value == quantum.value){
